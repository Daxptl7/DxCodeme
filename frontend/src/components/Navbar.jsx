        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <div className="flex items-center ml-6 border-l border-slate-200 dark:border-slate-700 pl-6">
                <button
                  onClick={toggleTheme}
                  className="relative inline-flex h-8 w-14 items-center rounded-full bg-slate-200 dark:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <span className="sr-only">Toggle theme</span>
                  <span
                    className={`${darkMode ? 'translate-x-7 bg-slate-800' : 'translate-x-1 bg-white'
                      } inline-block h-6 w-6 transform rounded-full shadow-md transition-transform duration-200 flex items-center justify-center`}
                  >
                    {darkMode ? <FiMoon size={14} className="text-indigo-400" /> : <FiSun size={14} className="text-amber-500" />}
                  </span>
                </button>
              </div>
            </div>
